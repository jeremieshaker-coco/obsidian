...
Used for Uber deliveries with 4-digit PIN. See [[Magic Lid Loading Flow]] for details.

**Characteristics:**
- Customer receives 4-digit code
- Customer enters code to unlock
- Primarily used for UberEats integration
- Firmware handles validation locally

### QR Code
**Identifier:** `source = 'QR'`

Customer scans QR code to unlock robot. See [[QR Loading Flow]] for details.
